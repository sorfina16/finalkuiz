...
<body background="">
	...
	<form action= "signup.php" class="panjang" method="post">
		<table>
			<tr>
				<td> ID Pelajar </td>
				<td><input type="text" name="idpelajar" placeholder="P001 max 4 char " pattern="[A-Z0-9]{4}" oninvalid="this.setCustomValidity('Sila masukkan 4 aksara')" oninput="this.setCustomValidity('')"required ></td>
			</tr>
			<tr>
				<td> Nama </td>
